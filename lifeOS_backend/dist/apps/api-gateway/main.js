...
let UserEnrichmentInterceptor = class UserEnrichmentInterceptor {
    ...
    intercept(context, next) {
        ...
        return (0, rxjs_1.from)((0, rxjs_1.firstValueFrom)(this.userService.send({ cmd: 'find_user_by_id' }, userId))).pipe((0, operators_1.switchMap)(user => {
            if (user) {
                const enrichedUser = {
...
exports.MicroservicesModule = MicroservicesModule = __decorate([
    (0, common_1.Module)({
        ...
        exports: [microservices_1.ClientsModule, user_enrichment_interceptor_1.UserEnrichmentInterceptor],
    })
], MicroservicesModule);
...
__decorate([
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [typeof (_q = typeof auth_interface_1.ICurrentUser !== "undefined" && auth_interface_1.ICurrentUser) === "function" ? _q : Object]),
    __metadata("design:returntype", typeof (_r = typeof auth_interface_1.ICurrentUser !== "undefined" && auth_interface_1.ICurrentUser) === "function" ? _r : Object)
