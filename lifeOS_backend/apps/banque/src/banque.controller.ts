...
export class BanqueController {
  ...
  public async getServiceWithDetails(@Payload() serviceId: number): Promise<IServiceWithDetails | null> {
  ...
  public async findServicesWithFilters(@Payload() filters: IServiceFilters): Promise<IServiceWithDetails[]> {
  ...
  public async getServiceCategoryById(@Payload() categoryId: number): Promise<IServiceCategory | null> {
