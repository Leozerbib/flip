...
DO $$ BEGIN
    ALTER TABLE public.pranks ADD CONSTRAINT pranks_coins_reward_executor_check CHECK ((coins_reward_executor >= 0));
EXCEPTION
    WHEN duplicate_object THEN null;
END $$;

DO $$ BEGIN
    ALTER TABLE public.pranks ADD CONSTRAINT pranks_coins_reward_target_check CHECK ((coins_reward_target >= 0));
EXCEPTION
    WHEN duplicate_object THEN null;
END $$;

DO $$ BEGIN
    ALTER TABLE public.pranks ADD CONSTRAINT pranks_default_jeton_cost_equivalent_check CHECK ((default_jeton_cost_equivalent >= 0));
EXCEPTION
    WHEN duplicate_object THEN null;
END $$;

DO $$ BEGIN
    ALTER TABLE public.pranks ADD CONSTRAINT pranks_name_key UNIQUE (name);
EXCEPTION
    WHEN duplicate_object THEN null;
END $$;

DO $$ BEGIN
    ALTER TABLE public.pranks ADD CONSTRAINT pranks_pkey PRIMARY KEY (prank_id);
EXCEPTION
    WHEN duplicate_object THEN null;
END $$;

DO $$ BEGIN
    ALTER TABLE public.pranks ADD CONSTRAINT pranks_xp_reward_executor_check CHECK ((xp_reward_executor >= 0));
EXCEPTION
    WHEN duplicate_object THEN null;
END $$;

DO $$ BEGIN
    ALTER TABLE public.pranks ADD CONSTRAINT pranks_xp_reward_target_check CHECK ((xp_reward_target >= 0));
EXCEPTION
    WHEN duplicate_object THEN null;
END $$;
...
DO $$ BEGIN
    ALTER TABLE public.service_categories ADD CONSTRAINT service_categories_pkey PRIMARY KEY (category_id);
EXCEPTION
    WHEN duplicate_object THEN null;
END $$;
...
DO $$ BEGIN
    ALTER TABLE public.users ADD CONSTRAINT users_game_coins_check CHECK ((game_coins >= 0));
EXCEPTION
    WHEN duplicate_object THEN null;
END $$;

DO $$ BEGIN
    ALTER TABLE public.users ADD CONSTRAINT users_level_check CHECK (("level" > 0));
EXCEPTION
    WHEN duplicate_object THEN null;
END $$;
...
DO $$ BEGIN
    ALTER TABLE public.users ADD CONSTRAINT users_xp_points_check CHECK ((xp_points >= 0));
EXCEPTION
    WHEN duplicate_object THEN null;
END $$;
...
-- Add constraints if they don't exist
DO $$ BEGIN
    ALTER TABLE public.friendships ADD CONSTRAINT check_different_users CHECK ((user_one_id <> user_two_id));
EXCEPTION
    WHEN duplicate_object THEN null;
END $$;

DO $$ BEGIN
    ALTER TABLE public.friendships ADD CONSTRAINT friendships_pkey PRIMARY KEY (friendship_id);
EXCEPTION
    WHEN duplicate_object THEN null;
END $$;

DO $$ BEGIN
    ALTER TABLE public.friendships ADD CONSTRAINT unique_friendship UNIQUE (user_one_id, user_two_id);
EXCEPTION
    WHEN duplicate_object THEN null;
END $$;

DO $$ BEGIN
    ALTER TABLE public.friendships ADD CONSTRAINT friendships_action_user_id_fkey FOREIGN KEY (action_user_id) REFERENCES public.users(user_id) ON DELETE CASCADE;
EXCEPTION
    WHEN duplicate_object THEN null;
END $$;

DO $$ BEGIN
    ALTER TABLE public.friendships ADD CONSTRAINT friendships_user_one_id_fkey FOREIGN KEY (user_one_id) REFERENCES public.users(user_id) ON DELETE CASCADE;
EXCEPTION
    WHEN duplicate_object THEN null;
END $$;

DO $$ BEGIN
    ALTER TABLE public.friendships ADD CONSTRAINT friendships_user_two_id_fkey FOREIGN KEY (user_two_id) REFERENCES public.users(user_id) ON DELETE CASCADE;
EXCEPTION
    WHEN duplicate_object THEN null;
END $$;
...
-- Add constraints if they don't exist
DO $$ BEGIN
    ALTER TABLE public.missions ADD CONSTRAINT missions_coins_reward_check CHECK ((coins_reward >= 0));
EXCEPTION
    WHEN duplicate_object THEN null;
END $$;

DO $$ BEGIN
    ALTER TABLE public.missions ADD CONSTRAINT missions_jeton_reward_check CHECK ((jeton_reward >= 0));
EXCEPTION
    WHEN duplicate_object THEN null;
END $$;

DO $$ BEGIN
    ALTER TABLE public.missions ADD CONSTRAINT missions_pkey PRIMARY KEY (mission_id);
EXCEPTION
    WHEN duplicate_object THEN null;
END $$;

DO $$ BEGIN
    ALTER TABLE public.missions ADD CONSTRAINT missions_repeat_cooldown_hours_check CHECK (((repeat_cooldown_hours IS NULL) OR (repeat_cooldown_hours >= 0)));
EXCEPTION
    WHEN duplicate_object THEN null;
END $$;
...
DO $$ BEGIN
    ALTER TABLE public.missions ADD CONSTRAINT missions_unlock_level_required_check CHECK ((unlock_level_required > 0));
EXCEPTION
    WHEN duplicate_object THEN null;
END $$;

DO $$ BEGIN
    ALTER TABLE public.missions ADD CONSTRAINT missions_xp_reward_check CHECK ((xp_reward >= 0));
EXCEPTION
    WHEN duplicate_object THEN null;
END $$;

DO $$ BEGIN
    ALTER TABLE public.missions ADD CONSTRAINT missions_prank_reward_id_fkey FOREIGN KEY (prank_reward_id) REFERENCES public.pranks(prank_id) ON DELETE SET NULL;
EXCEPTION
    WHEN duplicate_object THEN null;
END $$;
...
-- Add constraints if they don't exist
DO $$ BEGIN
    ALTER TABLE public.user_missions ADD CONSTRAINT user_missions_pkey PRIMARY KEY (user_mission_id);
EXCEPTION
    WHEN duplicate_object THEN null;
END $$;

DO $$ BEGIN
    ALTER TABLE public.user_missions ADD CONSTRAINT user_missions_progress_check CHECK ((progress >= 0));
EXCEPTION
    WHEN duplicate_object THEN null;
END $$;
...
DO $$ BEGIN
    ALTER TABLE public.user_missions ADD CONSTRAINT user_missions_mission_id_fkey FOREIGN KEY (mission_id) REFERENCES public.missions(mission_id) ON DELETE CASCADE;
EXCEPTION
    WHEN duplicate_object THEN null;
END $$;

DO $$ BEGIN
    ALTER TABLE public.user_missions ADD CONSTRAINT user_missions_user_id_fkey FOREIGN KEY (user_id) REFERENCES public.users(user_id) ON DELETE CASCADE;
EXCEPTION
    WHEN duplicate_object THEN null;
END $$;
...
DO $$ BEGIN
    CREATE TRIGGER update_user_missions_last_progress_at BEFORE UPDATE ON public.user_missions FOR EACH ROW EXECUTE FUNCTION update_updated_at_column();
EXCEPTION
    WHEN duplicate_object THEN null;
END $$;
...
-- Add constraints if they don't exist
DO $$ BEGIN
    ALTER TABLE public.services ADD CONSTRAINT check_provider_beneficiary_different CHECK ((provider_id <> beneficiary_id));
EXCEPTION
    WHEN duplicate_object THEN null;
END $$;

DO $$ BEGIN
    ALTER TABLE public.services ADD CONSTRAINT services_jeton_value_check CHECK ((jeton_value > 0));
EXCEPTION
    WHEN duplicate_object THEN null;
END $$;
...
CREATE TABLE IF NOT EXISTS public.executed_pranks (
...
-- Add constraints if they don't exist
DO $$ BEGIN
    ALTER TABLE public.executed_pranks ADD CONSTRAINT check_executor_target_different CHECK ((executor_id <> target_id));
EXCEPTION
    WHEN duplicate_object THEN null;
END $$;

DO $$ BEGIN
    ALTER TABLE public.executed_pranks ADD CONSTRAINT executed_pranks_jeton_value_paid_check CHECK ((jeton_value_paid >= 0));
EXCEPTION
    WHEN duplicate_object THEN null;
END $$;

DO $$ BEGIN
    ALTER TABLE public.executed_pranks ADD CONSTRAINT executed_pranks_pkey PRIMARY KEY (executed_prank_id);
EXCEPTION
    WHEN duplicate_object THEN null;
END $$;
...
DO $$ BEGIN
    CREATE TRIGGER update_executed_pranks_updated_at BEFORE UPDATE ON public.executed_pranks FOR EACH ROW EXECUTE FUNCTION update_updated_at_column();
EXCEPTION
    WHEN duplicate_object THEN null;
END $$;
